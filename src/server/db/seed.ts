    ...
    await db.insert(baseCompanies).values([
      {
        ...
        type: "Food",
        description:
          "St. Louis Area Foodbank. distributes 52,533,200 pounds of food to people facing hunger. Building stronger communities by empowering people with food and hope is a powerful mission to fulfill.",
        resources:
          "Food Assistance Programs, Nutrition Education, Community Outreach, Voluteer Opportunities, Holiday Meal Programs",
      ...
      },
      {
        ...
        type: "Healthcare",
        description:
          "Founded in 1879, SLCH is the oldest pediatric hospital west of the Mississippi River and the 7th oldest in the United States. SLCH has 455 licensed beds, which includes 77 pediatric intensive care beds, a 150-bed newborn intensive care unit, and a 16-bed pediatric bone marrow transplant unit.",
        resources:
          "Health Education Workshop, Mental Health Support, First Aid Training, School Health Clinics, Injury Prevention Programs",
      ...
      },
      {
        ...
        type: "Food",
        description:
          "Panera Bread Company owns and operates a chain of bakery-cafe fast casual restaurants. The Company offers breakfast sandwiches and wraps, salads, soups, pastries, coffee drinks, and other prepared foods for on-premise consumption. Panera Bread serves customers in the United States.",
        resources:
          "Food Donations, Meal Programs, Nutrition Education, Fundraising Opportunities, Employment Oppotunities",
      ...
      },
      {
        ...
        type: "Food",
        description:
          "Schnucks is a progressive, family-owned supermarket retailer with more than 100 stores in Missouri, Illinois, Indiana, and Wisconsin. Our corporate headquarters are located in St. Louis, Missouri.",
        resources:
          "Nutrition Workshops, Grocery Donations, Cooking Demonstrations, Job Opportunities, Community Engagement",
      ...
      },
      {
        ...
        type: "Technology",
        description:
          "Emerson Electric Co., a technology and software company, provides various solutions for customers in industrial, commercial, and consumer markets in the Americas, Asia, the Middle East, Africa, and Europe.",
        resources:
          "STEM Education, Equipment Donations, Mentorship Opportunities, Internship Programs, Sponsorship Support",
      ...
      },
      {
        ...
        resources:
          "Technology Donations, STEM Education, Career Development, Mentorship Opportunities, Scholarship Programs",
      ...
      },
      {
        ...
        resources:
          "Outdoor Education, Conservation Programs, Outdoor Recreation, Educational Materials, Volunteer Opportunities",
      ...
      },
      {
        ...
        type: "Transportation",
        description:
          "Metro Transit is an enterprise of the Bi-State Development Agency and operates public transportation services in the St. Louis region. In 2022, the system had an annual ridership of 19,049,100, or about 62,000 per weekday as of the third quarter of 2023. Greater St. Louis, Missouri–Illinois, U.S.",
        resources:
          "Transportation Access, Safety Education, Internship Opportunities, Community Engagement, Environmental Initiatives",
      ...
      },
      {
        ...
        type: "Financial",
        description:
          "The St. Louis Economic Development Partnership is a comprehensive economic development organization for St. Louis City and County, which attracts, retains, and facilitates growth of businesses and works collaboratively with public and private sector regional partners.",
        resources:
          "Career Guidance, Enterpreneurship Support, Workforce Training, Industry Insights, Economic Research",
      ...
      },
      {
        ...
        resources:
          "Academic Support, Counseling Services, Extracirricular Activities, College Preparation, Career Development",
      ...
      },
      {
        ...
        resources:
          "Health Education, Immunization Clinics, Mental Health Support, Sexual Health, Substance Abuse Prevention",
      ...
      },
      {
        ...
        type: "Food",
        description:
          "At Kaldis Coffee Roasting Company, we hand-roast all our coffees and blends in small batches. Our philosophy is to let the brilliance and beauty of our well-sourced beans shine through in the cup.",
        resources:
          "Coffee Catering, Fundraising Partnership, Student Discounts, Educational Workshops, Community Engagement",
      ...
      },
      {
        ...
        resources:
          "Coding Workshops, Tech Apprenticeships, Mentorship Programs, Career Pathways, Job Placement Assistance",
      ...
      },
      {
        ...
        type: "Financial",
        description:
          "Mastercard is a payment network processor. Mastercard partners with financial institutions that issue Mastercard payment cards processed exclusively on the Mastercard network. Mastercards primary source of revenue comes from the fees that it charges issuers based on each cards gross dollar volume.",
        resources:
          "Financial Literacy, STEM Scholarships, Career Development, Technology Education, Mentorship Programs",
